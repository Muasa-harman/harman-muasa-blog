...
//               {/* Flex container for the list and "Let us chat" */}
//               <div className="flex flex-col lg:flex-row mt-8 space-y-4 lg:space-y-0 lg:space-x-8 justify-between w-full">
//                 {/* Unordered list */}
...
//                 {/* New "Let us chat here" component */}
//                 <div className="bg-green-100 border border-green-300 rounded-lg p-4 flex items-center justify-center w-full lg:w-auto lg:flex-grow">
...
export default function Home() {
  return (
    <div className="bg-slate-50 grainy-light min-h-screen flex flex-col justify-between">
      {/* Main Content */}
      <main>
        {/* Hero Section */}
        <section>
          <MaxWidthWrapper className="pb-20 pt-8 lg:grid lg:grid-cols-3 sm:pb-28 lg:gap-x-0 xl:gap-x-8 lg:pt-10 xl:pt-16 lg:pb-40">
            <div className="col-span-2 px-6 lg:px-0">
              <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
                <h3 className="text-3xl font-bold">
                  Welcome to My Developer's Playground
