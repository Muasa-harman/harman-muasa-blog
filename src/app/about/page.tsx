            ...
            <div className="max-w-2xl mx-auto p-3 text-left">
              <div>
                ...
                <div className="text-md text-gray-500 flex flex-col gap-6">
                  ...
                  <p>
                    Jambo, my name is Harman Muasa, a software engineer living
                    and coding in Nairobi, Kenya. Outside my world of code, you
                    might find me connecting with nature through travel and
                    camping or pumping iron at the gym. However, I have a passion
                    for teaching, which enables me to stay up-to-date with trends
                    in tech to showcase my skills and share my thoughts and ideas
                    with the world that I have learned as a developer. I am
                    passionate about engineering because it lets me combine
                    problem-solving with building cool and innovative algorithms,
                    and I am fired up to share them with you. Above all, I find
                    deep strength and purpose in my devotion to God.
                  </p>
                  ...
                  <p>
                    ...
                    instilled strong values in me. My father, a dedicated military
                    man, taught me the importance of discipline and perseverance.
                    My mother, a nurturing small-scale farmer, grounded me with
                    her love for hard work and respect for my peers and elders as
                    well. Being raised in this environment shaped me into the
                    person I am today. One of the most cherished traditions in my
                    family is spending the Christmas season together with my
                    siblings and their families in Ukambani, our ancestral
                    homeland. Ukambani is a beautiful region in the eastern part
                    of Kenya, known for its rich cultural heritage. During this
                    time, we gather with extended family to celebrate, share
                    stories, and catch up as we strengthen our bond. The moments
                    of togetherness are a constant source of joy and inspiration
                    for me.
                  </p>
                  <h1 className="text-xl text-gray-700 font">
